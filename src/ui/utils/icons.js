 ...
 * Lucide-inspired icons for PirulinoColorete
 */
...
const icons = {
    ...
    mousePointer: `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m3 3 7.07 16.97 2.51-7.39 7.39-2.51L3 3z"/><path d="m13 13 6 6"/></svg>`,

    borderAll: `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><line x1="3" x2="21" y1="12" y2="12"/><line x1="12" x2="12" y1="3" y2="21"/></svg>`,
...
function createIcon(name, className = '') {
    ...
    wrapper.innerHTML = icons[name] || icons.sparkles;
    return wrapper;
}
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { icons, createIcon, getIcon };
}
